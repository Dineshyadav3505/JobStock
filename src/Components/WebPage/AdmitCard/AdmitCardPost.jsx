...
const AdmitCardPost = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const response = await axios.post('/admitCard/create', formData, {
        headers: {
    ...
    <div className='bg-zinc-900 min-h-screen'>
      ...
      <div className="flex">
        <div className="w-full px-8 md:px-16 py-5 relative mb-10">
          <h1 className='text-white text-center text-2xl font-bold mb-6'>Create AdmitCard  Post</h1>
          {loading ? (
