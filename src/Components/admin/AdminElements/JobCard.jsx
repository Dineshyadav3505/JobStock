  ...
  return (
    <div className=" p-5 mt-5 rounded-lg border-[1px] border-zinc-700 w-full md:w-[47vw] lg:w-[31.4vw]">
            <div className="flex gap-4 relative">
                ...
                {/* Share Button */}
                <div onClick={jobPostDetails}  className={`bg-zinc-600 flex justify-center items-center text-zinc-900 hover:text-[#119766] min-h-10 max-h-10 min-w-10 max-w-10 rounded-full p-2 ${saveBtn}`}>
