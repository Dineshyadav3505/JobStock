...
const AdminUpcomming = () => {
  ...
  return (
    ...
    <div className="p-5 flex flex-wrap justify-between bg-black pb-24">
        ...
        <NavLink to='/admin/upcommingPost' className={` h-10 w-full mt-3 rounded-md bg-[#119766] flex justify-center items-center text-[#F2F2F2] font-semibold`}> Create Up-Comming Job Post </NavLink>
